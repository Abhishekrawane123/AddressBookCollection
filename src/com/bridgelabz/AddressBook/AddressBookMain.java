...
public class AddressBookMain {
	...
	public static <T> void main(String[] args) {
		...
		MultiplePerson multipleAddressBooks = new MultiplePerson();
		...
		while (exit2 != 3) {
			...
			System.out.println("Enter Address Book name of a Person");
			...
			case 1:
				...
				while (exit != EXIT) {
					...
					case 1:
						System.out.println("Enter a name to check Contact exist or not ");
						String name1 = scanner.next();
						int count = contactPerson.dublicateAddress(name1, addressBook);
						if (count == 0) {
							addressBook = Contact.inputContactDetails();
				...
				multipleAddressBooks.mapBook.put(person, Contact.addreses);
